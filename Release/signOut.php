...
<body class="d-flex justify-content-center py-5 vh-150 signout">
	<main class="container customContainer d-flex flex-column justify-content-center align-items-center py-5">
			<div style ="text-align: center">
				...
				<h5>We hope to see you again!</h5>
				<button class="btn btn-std-5 btn-secondary" onclick="window.location.assign('index.php');"><i class="fas fa-sign-out-alt"></i> Return To Login Page</button>
			</div>
