...
<html>
    ...
    <h1 class="text-light"><a href="../index.php">Welcome to Guided Play</a></h1>
        <div class="heading">
            ...
            <button class="btn btn-outline-success" id="rcorners1" onclick="toggle4();">Upload Data</button>
            <button class="btn btn-outline-success" id="rcorners1" onclick="toggle5();">View Database</button>
            <button class="btn btn-outline-success" id="rcorners1" onclick="toggle6();">Manage Researchers</button>
        ...
        <div class="display" id="uploadDataResearch">
            <h2>Upload Data</h2>
		...
		<div id="viewDatabase" class=display>
			<div id="chartdiv2"></div>
		</div>
		
		<div class="container display" id="manageResearchers">
			<div class="row">
