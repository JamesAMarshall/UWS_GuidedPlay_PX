...
<html>
    ...
    <body>
        ...
        <div class="heading">
            ...
            <a class="btn btn-outline-success" id="rcorners2" >&nbsp;</a>
			<a class="btn btn-outline-success" id="rcorners1" >User ID</a>


            <button class="btn btn-outline-success" id="rcorners1" onclick="toggle1();">Submit Observation</button>
            <button class="btn btn-outline-success" id="rcorners1" onclick="toggle2();">Manage Classes</button>
            <button class="btn btn-outline-success" id="rcorners1" onclick="toggle3();">Upload Data</button>
        ...
        <div class="display" id="uploadDataSchool">
            <h2>Upload Data</h2>
		...
		<div class="display" id="submitObservation">
		...
		<div class="table-wrapper display" id="manageClasses">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-8"><h1><b>Manage Classes</b></h1></div>
					<div class="col-sm-4">
			...
			<table class="table table-bordered">
				...
				<tbody id="myTable">
					<tr>
						...
						<td>
							<a class="add" title="Add" data-display= id="""tooltip"><i class="material-icons">&#xE03B;</i></a>
							<a class="edit" title="Edit" data-display= id="""tooltip"><i class="material-icons">&#xE254;</i></a>
							<a class="delete" title="Delete" data-display= id="""tooltip"><i class="material-icons">&#xE872;</i></a>
						</td>
					</tr>
					<tr>
						<td>Peter110532</td>
